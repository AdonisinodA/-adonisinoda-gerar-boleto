    ...
    return new Promise((resolve) => {
      ...
      boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
            titulos.nomeDoPagador + "  " + pagador.getIdUsuario(),
            args.ajusteX + 32,
        ...
        const codigoDeBarras = boleto._codigoDeBarras
        const linhaDigitavel = GeradorDeLinhaDigitavel(boleto._codigoDeBarras, banco);
